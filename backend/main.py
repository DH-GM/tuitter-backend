...
def get_current_user_from_handle(
    db: Session, handle: str, auto_create: bool = True
) -> models.User:
    """
...
@app.post(
    "/conversations/{conversation_id}/messages", response_model=schemas.MessageResponse
)
def send_message(
    conversation_id: int,
...
def get_or_create_dm(
    ...
    if not user_a:
        raise HTTPException(
            status_code=404,
            detail=f"User '{conversation_data.user_a_handle}' not found",
        )
    if not user_b:
        raise HTTPException(
            status_code=404,
            detail=f"User '{conversation_data.user_b_handle}' not found",
        )
...
def root():
    """Root endpoint"""
    return {"service": "Social.vim API", "version": "1.0.0", "docs": "/docs"}
    ...
    try:
        ...
        users_data = [
            ...
            },
            {
                ...
                "bio": "Tech blogger | Code reviewer | Coffee enthusiast",
                "followers": 2345,
                "following": 890,
                "posts_count": 234,
            },
            {
                ...
                "bio": "CLI tools developer | Rust advocate",
                "followers": 456,
                "following": 234,
                "posts_count": 67,
            },
            {
                ...
                "bio": "Writing about technology and development",
                "followers": 3456,
                "following": 1234,
                "posts_count": 456,
            },
            {
                "username": "cliexpert",
                "display_name": "CLI Expert",
                "bio": "Terminal user interface expert",
                "followers": 2890,
                "following": 1100,
                "posts_count": 389,
            },
            {
                "username": "vimfan",
                "display_name": "Vim Fan",
                "bio": "Vim configuration enthusiast",
                "followers": 1567,
                "following": 678,
                "posts_count": 234,
            },
        ...
        posts_data = [
            {
                "author_id": created_users["yourname"],
                "author_handle": "yourname",
                "content": "Just shipped a new feature! The TUI is looking amazing 🚀",
                "likes_count": 12,
                "reposts_count": 3,
                "comments_count": 2,
            ...
            {
                "author_id": created_users["alice"],
                "author_handle": "alice",
                "content": "Working on a new CLI tool for developers. Any testers?",
                "likes_count": 45,
                "reposts_count": 12,
                "comments_count": 1,
            ...
            {
                "author_id": created_users["bob"],
                "author_handle": "bob",
                "content": "Refactoring is like cleaning your room. You know where everything is in the mess, but it's still better to organize it.",
                "likes_count": 234,
                "reposts_count": 67,
                "comments_count": 0,
            ...
            {
                "author_id": created_users["techwriter"],
                "author_handle": "techwriter",
                "content": "Just discovered this amazing TUI framework! #vim #tui #opensource",
                "likes_count": 234,
                "reposts_count": 45,
                "comments_count": 18,
            ...
            {
                "author_id": created_users["cliexpert"],
                "author_handle": "cliexpert",
                "content": "Hot take: TUIs are making a comeback! 💻",
                "likes_count": 189,
                "reposts_count": 52,
                "comments_count": 34,
            ...
            {
                "author_id": created_users["vimfan"],
                "author_handle": "vimfan",
                "content": "Finally got my vim config working with this social network.",
                "likes_count": 156,
                "reposts_count": 28,
                "comments_count": 12,
